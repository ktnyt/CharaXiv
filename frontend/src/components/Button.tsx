...
export type ButtonVariant = 'default' | 'outline' | 'textual'
...
export const Button: Component<ButtonProps> = (props) => {
  const style = (variant: ButtonVariant, color: ButtonColor) =>
    ...
    <button
      ...
      class={clsx(
        ...
        clsx(
          ...
          style('outline', 'default') && 'border-solid border border-nord-600   bg-nord-500   bg-opacity-0 text-nord-600   hover:bg-opacity-20 dark:border-nord-300 dark:text-nord-300',
