...
def test_configure() -> None:
    ...
    registration_delete_by_email = injector.get(protocols.registration_delete_by_email.Protocol)
    assert type(registration_delete_by_email) == adapters.registration_delete_by_email.Adapter
    assert isinstance(registration_delete_by_email, protocols.registration_delete_by_email.Protocol)
    ...
    registration_delete_by_token = injector.get(protocols.registration_delete_by_token.Protocol)
    assert type(registration_delete_by_token) == adapters.registration_delete_by_token.Adapter
    assert isinstance(registration_delete_by_token, protocols.registration_delete_by_token.Protocol)
