...
def test_configure() -> None:
    ...
    db_user_get_by_id = injector.get(protocols.db_user_get_by_id.Protocol)
    assert type(db_user_get_by_id) == adapters.db_user_get_by_id.Adapter
    assert isinstance(db_user_get_by_id, protocols.db_user_get_by_id.Protocol)
    ...
    db_password_reset_request_get_by_token = injector.get(protocols.db_password_reset_request_get_by_token.Protocol)
    assert type(db_password_reset_request_get_by_token) == adapters.db_password_reset_request_get_by_token.Adapter
    assert isinstance(db_password_reset_request_get_by_token, protocols.db_password_reset_request_get_by_token.Protocol)
    ...
    db_user_get_by_email = injector.get(protocols.db_user_get_by_email.Protocol)
    assert type(db_user_get_by_email) == adapters.db_user_get_by_email.Adapter
    assert isinstance(db_user_get_by_email, protocols.db_user_get_by_email.Protocol)
    ...
    db_registration_get_by_token = injector.get(protocols.db_registration_get_by_token.Protocol)
    assert type(db_registration_get_by_token) == adapters.db_registration_get_by_token.Adapter
    assert isinstance(db_registration_get_by_token, protocols.db_registration_get_by_token.Protocol)
