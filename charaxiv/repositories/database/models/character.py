...
class Character(Base, AutoIDMixin, TimestampMixin):
    ...
    ruby: Mapped[str] = mapped_column("ruby", sqlalchemy.String(255), nullable=False, sort_order=3)
    data: Mapped[bytes] = mapped_column("data", sqlalchemy.LargeBinary(), nullable=False, sort_order=4)
