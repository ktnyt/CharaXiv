...
from charaxiv.adapters.db_password_reset_request_delete_by_user_id import \
    Adapter


@pytest.mark.asyncio
async def test_password_reset_reqeust_delete_by_user_id(database_session: AsyncSession, password_hasher: PasswordHasher) -> None:
