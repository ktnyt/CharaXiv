...
from charaxiv.adapters.user_get_by_email import Adapter


@pytest.mark.asyncio
async def test_user_get_by_email(database_session: AsyncSession, password_hasher: PasswordHasher) -> None:
