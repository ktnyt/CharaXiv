...
from charaxiv.adapters.db_user_get_by_id import Adapter


@pytest.mark.asyncio
async def test_db_user_get_by_id(database_session: AsyncSession, password_hasher: PasswordHasher) -> None:
